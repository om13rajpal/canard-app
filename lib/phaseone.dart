...
class PhaseOne extends StatefulWidget {
  final dynamic token;
  const PhaseOne({@required this.token, Key? key}) : super(key: key);
...
class _PhaseOneState extends State<PhaseOne> {
  ...
  void getTasks() async {
    ...
    if (jsonRes['status']) {
      ...
      mainTaskPercentage =
          (jsonRes['data']['team']['phase1']['completedTasks'] / 5) * 100;
      int task1 = jsonRes['data']['team']['phase1']['taskOrder'][0];
      int task2 = jsonRes['data']['team']['phase1']['taskOrder'][1];
      int task3 = jsonRes['data']['team']['phase1']['taskOrder'][2];
      int task4 = jsonRes['data']['team']['phase1']['taskOrder'][3];
      int task5 = jsonRes['data']['team']['phase1']['taskOrder'][4];

      mainTask = jsonRes['data']['team']['phase1']['completedTasks'];
      minorTask = jsonRes['data']['team']['phase1']['minorCompletedTasks'];
      taskOne = jsonRes['data']['team']['phase1']['tasks']['$task1']['title'];
      taskTwo = jsonRes['data']['team']['phase1']['tasks']['$task2']['title'];
      taskThree = jsonRes['data']['team']['phase1']['tasks']['$task3']['title'];
      taskFour = jsonRes['data']['team']['phase1']['tasks']['$task4']['title'];
      print(taskFour);
      taskFive = jsonRes['data']['team']['phase1']['tasks']['$task5']['title'];
      taskSix = jsonRes['data']['team']['phase1']['tasks']['106']['title'];
      taskSeven = jsonRes['data']['team']['phase1']['tasks']['107']['title'];
      taskEight = jsonRes['data']['team']['phase1']['tasks']['108']['title'];
      hintOne = jsonRes['data']['team']['phase1']['tasks']['$task1']['hint'];
      print(hintOne);
      hintTwo = jsonRes['data']['team']['phase1']['tasks']['$task2']['hint'];
      hintThree = jsonRes['data']['team']['phase1']['tasks']['$task3']['hint'];
      hintFour = jsonRes['data']['team']['phase1']['tasks']['$task4']['hint'];
      hintFive = jsonRes['data']['team']['phase1']['tasks']['$task5']['hint'];
      locationOne =
          jsonRes['data']['team']['phase1']['tasks']['$task1']['description'];
      locationTwo =
          jsonRes['data']['team']['phase1']['tasks']['$task2']['description'];
      locationThree =
          jsonRes['data']['team']['phase1']['tasks']['$task3']['description'];
      locationFour =
          jsonRes['data']['team']['phase1']['tasks']['$task4']['description'];
      locationFive =
          jsonRes['data']['team']['phase1']['tasks']['$task5']['description'];
      locationSix =
          jsonRes['data']['team']['phase1']['tasks']['106']['description'];
      locationSeven =
          jsonRes['data']['team']['phase1']['tasks']['107']['description'];
      locationEight =
          jsonRes['data']['team']['phase1']['tasks']['108']['description'];
      taskoneHint =
          jsonRes['data']['team']['phase1']['tasks']['$task1']['hintActive'];
      tasktwoHint =
          jsonRes['data']['team']['phase1']['tasks']['$task2']['hintActive'];
      taskthreeHint =
          jsonRes['data']['team']['phase1']['tasks']['$task3']['hintActive'];
      taskfourHint =
          jsonRes['data']['team']['phase1']['tasks']['$task4']['hintActive'];
      taskfiveHint =
          jsonRes['data']['team']['phase1']['tasks']['$task5']['hintActive'];
      status = jsonRes['data']['team']['phase1']['status'];
      if (status == 'completedAll' ||
          status == 'completed' ||
          status == 'failed') {
        timeTaken = jsonRes['data']['team']['phase1']['timeTaken'];
        print(timeTaken);
      ...
      taskOneStatus =
          jsonRes['data']['team']['phase1']['tasks']['$task1']['status'];
      taskTwoStatus =
          jsonRes['data']['team']['phase1']['tasks']['$task2']['status'];
      taskThreeStatus =
          jsonRes['data']['team']['phase1']['tasks']['$task3']['status'];
      taskFourStatus =
          jsonRes['data']['team']['phase1']['tasks']['$task4']['status'];
      taskFiveStatus =
          jsonRes['data']['team']['phase1']['tasks']['$task5']['status'];

      taskFSixStatus =
          jsonRes['data']['team']['phase1']['tasks']['106']['status'];
      taskSevenStatus =
          jsonRes['data']['team']['phase1']['tasks']['107']['status'];
      taskEightStatus =
          jsonRes['data']['team']['phase1']['tasks']['108']['status'];
          ...
          children: [
            SingleChildScrollView(
              child: Column(
                ...
                children: [
                  GifAnim(
                    gifPath: 'assets/gif/phaseone.gif',
                    phaseTwo: false,
                    phase: 1,
                    teamid: teamid,
                  ),
